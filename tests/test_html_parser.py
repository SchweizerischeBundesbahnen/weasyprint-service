...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            # full HTML document
            ("<?xml version='1.0' encoding='UTF-8'?><!DOCTYPE html><html><head><title>X</title></head><body><p>Y</p></body></html>"),
            ("<?xml version='1.0' encoding='UTF-8'?><!DOCTYPE html><html><head><title>X</title></head><body><p>Y</p></body></html>"),
        ),
        (
            # SVG with viewBox and foreignObject (register is saved as is)
            ('<svg width="100" height="100" viewBox="0 0 100 100"><foreignObject width="100%" height="100%"><div xmlns="http://www.w3.org/1999/xhtml">Test</div></foreignObject></svg>'),
            ('<svg height="100" viewBox="0 0 100 100" width="100"><foreignObject height="100%" width="100%"><div xmlns="http://www.w3.org/1999/xhtml">Test</div></foreignObject></svg>'),
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            (
                "<div style='break-after:page'>page to be removed</div>"
                "<?xml version='1.0' encoding='UTF-8'?>"
